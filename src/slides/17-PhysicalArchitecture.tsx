  ...
  return (
    <div className="slide-root">
      <div
        ...
        style={{ background: 'radial-gradient(ellipse at 30% 60%, rgba(0,184,179,0.05) 0%, transparent 55%)' }}
      />
      ...
      >
        ...
        <motion.div variants={stagger} initial="hidden" animate="visible" className="flex-shrink-0 flex flex-col gap-0.5">
          ...
          <motion.p variants={fadeUp} className="text-xs text-px-muted">
            Docker Compose deployment · containerised services · network segmentation
          </motion.p>
        </motion.div>
        ...
        <AnimatePresence>
          {step >= 1 && (
            ...
            >
              <img
                src="/arch-phys.png"
                alt="PEAXIS Physical Architecture"
