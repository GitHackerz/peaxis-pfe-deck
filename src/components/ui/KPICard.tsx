...
const colorMap = {
  teal:   { value: '#00B8B3', bg: '#F8FAFC', border: 'rgba(0,0,0,0.07)' },
  coral:  { value: '#FE595A', bg: '#FFF0F0', border: 'rgba(254,89,90,0.15)' },
  yellow: { value: '#001027', bg: '#F3F4F6', border: 'rgba(0,0,0,0.07)' },
  navy:   { value: '#001027', bg: '#F3F4F6', border: 'rgba(0,0,0,0.07)' },
}
